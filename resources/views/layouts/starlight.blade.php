...
<html lang="en">
  <head>
    ...
    <title>Bangla- @yield('title')</title>
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>BANGLA</a></div>
      ...
      <div class="sl-sideleft-menu">
        <a href="{{url('/home')}}" class="sl-menu-link @yield('active')">
          ...
          <div class="sl-menu-item">
           ...
           <li class="nav-item"><a href="{{url('/about')}}" class="nav-link">Details</a></li>
        </ul>
          </a><!-- sl-menu-link -->
          <a href="#" class="sl-menu-link @yield('department')">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
            <span class="menu-item-label">Department Info</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
           <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/depart')}}" class="nav-link">Add Department</a></li>
        </ul>
        </a><!-- sl-menu-link -->
          <a href="#" class="sl-menu-link @yield('trashed')">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
            <span class="menu-item-label">Trash Info</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
           <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/depart/trashed')}}" class="nav-link">Move Trash</a></li>
        </ul>
        </a><!-- sl-menu-link -->
          <a href="#" class="sl-menu-link @yield('employee')">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
            <span class="menu-item-label">Employee Info</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
        </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
           <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/employ')}}" class="nav-link">Add Employee</a></li>
        </ul>
        </a><!-- sl-menu-link -->
          <a href="#" class="sl-menu-link @yield('inactive')">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
            <span class="menu-item-label">Trash Info</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
           ...
           <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/employ/trashed')}}" class="nav-link">Move Trash</a></li>
        </ul>
        </a><!-- sl-menu-link -->
